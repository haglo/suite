...
public class IFrame extends HtmlComponent {
	...
	public enum SandboxType {
		RESTRICT_ALL(""), ALLOW_FORMS("allow-forms"), ALLOW_MODALS("allow-modals"),
		ALLOW_ORIENTATION_LOCK("allow-orientation-lock"), ALLOW_POINTER_LOCK("allow-pointer-lock"),
		ALLOW_POPUPS("allow-popups"), ALLOW_POPUPS_TO_ESCAPE_SANDBOX("allow-popups-to-escape-sandbox"),
		ALLOW_PRESENTATION("allow-presentation"), ALLOW_SAME_ORIGIN("allow-same-origin"),
	...
	public void setSandbox(SandboxType... types) {
		if (types == null || types.length == 0) {
			...
			// NOTE: "allow-all" is used internally to remove the property in this case when
			// types argument is null.
			// It is the default value of the sandboxDescriptor, thus when it is set the
			// descriptor will remove the property.
